...
readonly BUILD_DATE="2025-12-08T12:29:00Z"
...
# Disable any graphical terminal
terminal_output console

menuentry "autoboot" {
    set gfxpayload=keep
    linux /boot/casper/vmlinuz ip=dhcp boot=casper netboot=nfs \\
        nfsroot=$SERVER_IP:$PXE_ROOT quiet splash ---
